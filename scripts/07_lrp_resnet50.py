# -*- coding: utf-8 -*-
"""
First LRP test: LRP on ResNet50, single image.
Isolated check before integrating LRP into the full matrix.
"""
...
axes[1].set_title("LRP (EpsilonGammaBox)")
axes[1].axis("off")
...
# --- 4. Save ---
plt.tight_layout()
out_path = FIGURES_DIR / "07_lrp_resnet50_dog.png"
